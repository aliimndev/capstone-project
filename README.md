...
> A cinematic movie discovery app powered by a hybrid recommender system, TMDB metadata, runtime-loaded ML artifacts, and a production-ready contact flow.
...
Capstone project by the **WeMovies AI Team**.

If you are using this repository as a portfolio or open-source demo, the architecture diagrams in [`docs/architecture.md`](docs/architecture.md) are designed to be presentation-ready and easy to embed in project write-ups or technical case studies.
